...
//User clientVladislav = clientService.Register(
//    "Maksimenkov",
//    "Vladislav",
//    "Aleksandrovich",
//    "Passport",
...
//foreach (var acc in (clientVladislav as Client).Accounts)
//{
//    Console.WriteLine(acc.ToString());
//}

//Console.WriteLine("Credits:");
//foreach (var cred in (clientVladislav as Client).Credits)
//{
//    Console.WriteLine(cred.ToString());
//}

//Console.WriteLine("Installments:");
//foreach (var inst in (clientVladislav as Client).Installments)
//{
//    Console.WriteLine(inst.ToString());
//}

//Console.WriteLine("Deposits:");
//foreach (var dep in (clientVladislav as Client).Deposits)
//{
